    ...
    timedAction(
      function (index) {
        ...
        switch (action) {
          ...
          default:
            S.Shape.switchShape(
              S.ShapeBuilder.letter(current[0] === cmd ? "Urie" : current)
            );
        }
      },
      3000,
  ...
  return {
    ...
    letter: function (l) {
      ...
      if (!isPC() && l.indexOf("+") != -1) {
        ...
        s = Math.min(
          fontSize,
          (shapeCanvas.width / shapeContext.measureText(twoWords[0]).width) *
            0.8 *
            fontSize,
          (shapeCanvas.width / shapeContext.measureText(twoWords[1]).width) *
            0.8 *
            fontSize,
